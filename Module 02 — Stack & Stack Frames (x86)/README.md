...
The stack is one of the most important components in x86 reverse engineering.
It stores:
...
✔ ESP → stack pointer (dynamic)
✔ EBP → base pointer (stable reference inside function)
...
🧠 Relationship Between ESP and EBP
✔ EBP is stable
...
Negative offsets = locals.
Positive offsets = arguments.
