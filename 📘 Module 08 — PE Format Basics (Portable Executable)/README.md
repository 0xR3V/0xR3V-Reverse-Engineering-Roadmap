...
### ✔ `Optional Header` (MOST IMPORTANT PART)

Despite the name, it is **not optional** for PE files.

---

# 🎯 5. Optional Header — Critical Fields
...
| **AddressOfEntryPoint** | RVA of the program’s first executed instruction |
...
# 📦 7. Section Table (Section Headers)
...
# 🛠️ 10. Matching EP to Its Section
...
- `.idata` = import table  
- `.rsrc` = resources  
- Section Table maps file → memory  

---

# 🧪 13. Exercises

✔ **Q1:** What is the difference between RVA and VA?  
✔ **Q2:** Where is AddressOfEntryPoint located?  
✔ **Q3:** Why is the Entry Point usually in `.text`?  
...
✔ **Q5:** What is stored in the `.rdata` section?
